...
module.exports = app => {
  ...
  router.get('/api/menu/detail', jwt, controller.menu.detail);
  ...
  router.post('/api/about/move', jwt, controller.about.move);
  ...
  router.post('/api/company/move', jwt, controller.company.move);
  ...
  router.post('/api/news/move', jwt, controller.news.move);
  ...
  // apiCode
  router.get('/api/apiCode/index', jwt, controller.apiCode.index)
  router.post('/api/apiCode/add', jwt, controller.apiCode.add)
  router.post('/api/apiCode/edit', jwt, controller.apiCode.edit)

  // exception
  router.get('/api/exception/index', jwt, controller.exception.index)
